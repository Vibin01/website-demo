...
function RightCard() {
  return (
    <div className="flex flex-col justify-center items-center mt-xl w-full h-fit sm:w-[35%] rounded-md bg-white p-md shadow-[0px_4px_35px_4px_#0668E11A]">
      <h3 className="text-center text-base font-bold text-[#0668E1] flex items-start gap-xs">
        Everyone Achieves Seamless Yield <img src={"/icons/tm-badge.svg"} alt="tm-badge" className="size-[14px]"/>
      </h3>

      {/* Diagram */}
      <div className="relative mx-auto mt-lg h-auto w-full">
        <img
          src="/home/aspire-align-achieve-hiring-alignment-across-candidate-recruiter-employer.svg"
          alt="Aspire Align Achieve model showing hiring alignment across candidate, recruiter, and employer"
          className="size-full"
        />
      </div>

      {/* Bottom labels */}
      <div className="mx-auto mt-lg flex w-full justify-between">
      ...
      <p className="mt-[1vw] text-center text-base font-bold  flex items-start gap-xs">
        Everyone Aspires Seamless Yield <img src={"/icons/tm-badge-black.svg"} alt="tm-badge" className="size-[14px]"/>
      </p>
    </div>
  );
}
    ...
    <section className="mx-auto ">
      ...
      <div className="flex flex-col-reverse sm:flex-row items-center justify-between gap-[4%]">
        ...
        <div className="">
          ...
          <div className="mt-sm ">
            <p className="text-base font-medium">Situation, Direction, and Execution are aligned.</p>
            <p className="text-base font-medium">The outcome is reliable.</p>
            <p className="mt-sm text-base font-medium">This state is called:</p>
            <p className="text-base font-bold text-[#0668E1]"> EASY: Everyone Achieves Seamless Yield</p>
