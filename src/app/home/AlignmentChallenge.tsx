...
const AlignmentChallenge = () => {
  return (
    <>
      <div className="">
        <h1 className="text-h2 font-extrabold"> The Alignment Challenge</h1>

        <p className="text-h6 font-bold mt-xs mb-lg">
          Seamless Yield depends on alignment across three dimensions of hiring.
        </p>

        <div
          className=" bg-white border border-[#DEEDFF] rounded-md p-md flex flex-col 
        ...
        >
          ...
          <div>
            <p className="text-base font-bold mt-md">When they misalign:</p>

            <div className="mt-xs flex flex-col sm:flex-row sm:items-center gap-sm md:gap-lg text-base font-medium">
        ...
        <div className="mt-sm text-base font-medium space-y-sm">
          <p className="text-base font-medium">
            Alignment does not happen within actors. It occurs between them.
          </p>
          <p className="text-base font-medium">
            These interaction points are called seams.
          </p>
        </div>
      </div>
    </>
