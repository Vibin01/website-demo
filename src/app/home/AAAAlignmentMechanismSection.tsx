  ...
  return (
    <div className="flex items-start gap-xs rounded-md border border-[#D3E6FF] bg-white p-sm">
      ...
      <div>
        ...
        <p className="mt-xs text-base md:text-xl font-medium text-[#2C2C2C]">
          {item.description}
        </p>
      </div>
    </div>
...
export default function AAAAlignmentMechanismSection() {
  return (
    <section className="flex flex-col md:flex-row  items-center justify-between">
      ...
      <img src="/home/alignment-model-direction-execution-situation-in-hiring.svg" alt="Alignment model showing direction, execution, and situation in the hiring process" className="h-auto w-full  " />
    </div></section>
  );
}