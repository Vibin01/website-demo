            ...
            <div className="mt-md flex justify-between gap-sm">
              {showBackButton ? (
                <button
                  type="button"
                  onClick={handleBack}
                  className="flex h-[48px] items-center rounded-sm border border-[#0668E1] px-md text-xl font-medium text-[#0668E1]"
                >
                  Back
                </button>
              ) : (
              ...
              <button
                ...
                className={`flex h-[48px] items-center gap-sm rounded-sm px-md text-xl font-medium text-white
                  ${
