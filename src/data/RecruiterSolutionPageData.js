...
,
metadata: {
      title: "Collect Interview Feedback Faster | Connect EC",
      description:
        "Collect interview feedback faster with structured templates that reduce repetitive follow-ups. Use stage-based templates to reduce repetitive feedback work with Connect EC.",
    },
   InsightTabItem:   [
  {
    id: 1,
...
FeatureHighlightData : {
  ...
  image: {
    src: "/solutions/recruiter/interview-feedback-and-evaluation-for-candidates.svg",
    alt: "Interview feedback and evaluation helping candidates understand performance and decisions",
  },
 ...
 InsightOutcomeData : {
  mainCard: {
    image: {
      src: "/solutions/recruiter/understanding-alignment.svg",
...
,
 ...
 export const  easyFacilitator={
    ...
    ,
    metadata: {
      title: "Improve Offer to Joining Conversion and Reduce Dropouts | Connect EC",
      description:
        "Improving offer to joining conversion helps recruiters keep candidates engaged and detect commitment risks early. Reduce dropouts and secure hires with Connect EC.",
    },
...
FeatureHighlightData : {
  ...
  image: {
    src: "/solutions/recruiter/job-offer-decision-alignment-for-candidates.svg",
    alt: "Job offer decision alignment showing how candidates evaluate and respond to offers",
  },
  flowSteps:[
...
,
 ...
 export const  easyScheduler={
    ...
    ,
 metadata: {
      title: "Manage Interview Scheduling and Coordination | Connect EC",
      description:
        "Managing interview scheduling helps recruiters track availability, coordinate candidates and panels, and avoid missed updates. Keep interviews on track with Connect EC.",
    },
   InsightTabItem:   [
  {
    id: 1,
...
structuredData: {
  ...
  image: {
    src: "/solutions/recruiter/manage-interview-schedule-and-availability-for-candidates.svg",
    alt: "Manage interview schedule with options to accept, decline, or reschedule based on availability",
  },
  flowSteps:[
...
export const  easyPredictor={
    ...
    ,
 metadata: {
      title: "Predict Interview No-Shows Before They Happen | Connect EC",
      description:
        "Predict interview no-shows early by detecting disengagement signals before interviews. Protect panel time and improve attendance with Connect EC.",
    },
   InsightTabItem:   [
  {
    id: 1,
...
FeatureHighlightData : {
  ...
  image: {
    src: "/solutions/recruiter/interview-participation-alignment-for-recruiters.svg",
    alt: "Interview participation alignment showing candidate engagement signals before interviews",
  },
  flowSteps:[
