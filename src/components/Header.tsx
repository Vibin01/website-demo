...
>
    <button
      ...
      className="w-[110px] h-[44px] border border-[#0668E1] text-[#0668E1] rounded-sm"
    >
      Login
    </button>
        ...
        <div className="space-y-sm">
          {authOptions.map((item) => (
            <Link
              ...
              href={item.login}
              target="_blank"
              className="flex items-center gap-3 rounded-sm p-sm hover:bg-[#F4F8FF] transition"
            >
              <img
                src={item.icon}
                alt={item.label}
...
>
    <button
      ...
      className="w-[110px] h-[44px] bg-[#0668E1] rounded-sm text-white"
    >
      Register
    </button>
        ...
        <div className="space-y-sm">
          {authOptions.map((item) => (
            <Link
              ...
              href={item.register}
              target="_blank"
              className="flex items-center gap-3 rounded-xl p-sm hover:bg-[#F4F8FF] transition"
            >
              <img
                src={item.icon}
                alt={item.label}
